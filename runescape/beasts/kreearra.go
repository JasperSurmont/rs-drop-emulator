...
var (
	...
	kreearraCommonDroptable = []core.Drop{
		{
	...
	kreearraUncommonDroptable = []core.Drop{
		{
	...
	kreearraRareDroptable = []core.Drop{
		{
			Name: "Armadyl helmet",
			Rate: 1.0 / 384.0,
			Bold: true,
	...
	aramadylHilt = core.Drop{
		Name:   "Armadyl hilt",
		Amount: 1,
	}
	kreearraAlwaysDroptable = []core.Drop{
		{
			Name:   "Big bones",
			Amount: 1,
		},
